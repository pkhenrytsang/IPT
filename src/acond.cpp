/*
	Analytic Continuation for Self energy defined on real-axis to the Matsubara axis
	By Pak Ki Henry Tsang Aug 2020
	Fitting code adapted from https://www.gnu.org/software/gsl/doc/html/nls.html
*/
